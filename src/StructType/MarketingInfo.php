...
class MarketingInfo extends AbstractStructBase
{
     ...
     */
    public function __construct(?string $areaCode = null, ?string $travelDuration = null, ?string $season = null, ?string $travelType = null, ?string $transportation = null, ?string $personCount = null, ?\Pggns\MidocoApi\Booking\StructType\SearchCriteria $searchCriteria = null, array $attribute = [])
    {
        $this
