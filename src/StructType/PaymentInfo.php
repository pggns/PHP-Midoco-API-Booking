...
class PaymentInfo extends AbstractStructBase
{
     ...
     */
    public function __construct(array $ccPayment = [], ?\Pggns\MidocoApi\Booking\StructType\DebitPayment $debitPayment = null, ?\Pggns\MidocoApi\Booking\StructType\AdvisedPayment $advisedPayment = null, ?string $preferredPaymentType = null)
    {
        $this
