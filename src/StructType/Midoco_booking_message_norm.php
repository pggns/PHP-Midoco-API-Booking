...
class Midoco_booking_message_norm extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Booking\StructType\AgencyIdentity $agencyIdentity = null, array $customer = [], array $packageInfo = [], array $booking = [], ?\Pggns\MidocoApi\Booking\StructType\Prices $prices = null, array $ticket = [], ?\Pggns\MidocoApi\Booking\StructType\PaymentInfo $paymentInfo = null, ?\Pggns\MidocoApi\Booking\StructType\MarketingInfo $marketingInfo = null, ?\Pggns\MidocoApi\Booking\StructType\Internal_treatment $internal_treatment = null, array $orderRemark = [], array $externalPayment = [], array $importedDocument = [], array $dunningInfo = [], array $voucher = [], array $verkData = [], ?int $messageVersion = 1)
    {
        $this
