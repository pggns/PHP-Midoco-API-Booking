...
class Customer_1 extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Booking\StructType\PrivateData_1 $privateData = null, ?\Pggns\MidocoApi\Booking\StructType\CompanyData_1 $companyData = null, ?\Pggns\MidocoApi\Booking\StructType\Address $address = null, array $communication = [], array $creditCardRefId = [], array $bankAccountRefId = [], ?int $midocoCustomerId = null, ?string $referenceCustomerId = null, ?string $referenceSystem = null, ?string $referenceUrl = null, ?string $type = 'INVOICE', ?bool $overrideExistingOrderCustomer = false)
    {
        $this
